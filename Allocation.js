...
import HomeScreen from "../Music/Home";
...
const AllocationList = ({ navigation }) => {
  ...
  const imagebackground = require('../Assets/bg0.jpg');
  const userpic = require('../Assets/userimg.png');
  const clockpic = require('../Assets/clockimg.png');
